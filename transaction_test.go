...
func TestRedeemQuai(t *testing.T) {
	...
	inner_tx := types.QuaiTx{ChainID: PARAMS.ChainID, Nonce: nonce, MinerTip: MINERTIP, GasPrice: BASEFEE, Gas: GAS * 10, To: &toAddr, Value: common.Big0, Data: nil, AccessList: types.AccessList{}}
...
func TestQuaiConversion(t *testing.T) {
	...
	inner_tx := types.QuaiTx{ChainID: PARAMS.ChainID, Nonce: nonce, MinerTip: MINERTIP, GasPrice: BASEFEE, Gas: GAS * 10, To: &to, Value: big.NewInt(params.Ether), Data: nil, AccessList: types.AccessList{}}
	tx := types.NewTx(&inner_tx)
	tx, err = types.SignTx(tx, signer, privKey)
	if err != nil {
		t.Error(err.Error())
...
func TestETX(t *testing.T) {
	...
	inner_tx := types.QuaiTx{ChainID: PARAMS.ChainID, Nonce: nonce, MinerTip: MINERTIP, GasPrice: BASEFEE, Gas: GAS * 3, To: &to, Value: VALUE, Data: nil, AccessList: types.AccessList{}}
	tx := types.NewTx(&inner_tx)
...
func TestETXs(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		...
		inner_tx := types.QuaiTx{ChainID: PARAMS.ChainID, Nonce: nonce, MinerTip: MINERTIP, GasPrice: BASEFEE, Gas: GAS * 3, To: &toAddress, Value: VALUE, Data: nil, AccessList: types.AccessList{}}
		tx := types.NewTx(&inner_tx)
...
func TestETXSmartContract(t *testing.T) {
	...
	inner_tx := types.QuaiTx{ChainID: PARAMS.ChainID, Nonce: nonce, MinerTip: MINERTIP, GasPrice: MAXFEE, Gas: 5000000, To: &toAddr, Value: common.Big0, Data: contract}
...
func TestSmartContract(t *testing.T) {
	...
	robert_contract, _ := hex.DecodeString("")

	inner_tx := types.QuaiTx{ChainID: PARAMS.ChainID, Nonce: nonce, GasPrice: MINERTIP, MinerTip: MAXFEE, Gas: 5000000, To: nil, Value: common.Big0, Data: robert_contract}

	// get access list
	accessList, err := client.CreateAccessList(context.Background(), interfaces.CallMsg{From: fromAddress, To: nil, Gas: 4000000, GasPrice: MINERTIP, MinerTip: MINERTIP, Value: common.Big0, Data: robert_contract})
	if err != nil {
		fmt.Println(err.Error())
		return
	}

	inner_tx.AccessList = append(inner_tx.AccessList, *accessList.Accesslist...)

	gas, err := client.EstimateGas(context.Background(), interfaces.CallMsg{From: fromAddress, GasPrice: MAXFEE, MinerTip: MAXFEE /*To: nil, Gas: 0, GasPrice: MAXFEE, GasFeeCap: MAXFEE, GasTipCap: MINERTIP, Value: common.Big0, */, Data: robert_contract, AccessList: inner_tx.AccessList})
	if err != nil {
		fmt.Println(err.Error())
		return
	}
